    ...
    <div className="fixed top-1/4 right-0 flex flex-col mx-1 space-y-2 z-30">
      {icons.map(({ id, icon: Icon, link }) => (
        <a
          ...
          className="bg-gray-100 text-black md:w-14 md:h-14 w-10 h-10 flex items-center justify-center md:rounded-xl rounded-lg shadow-lg hover:bg-green-500 hover:text-white transition ease-in-out delay-100"
        >
